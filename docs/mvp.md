...
- Coleta Yahoo + OpLab + Fundamentus → snapshot em disco. Botão Atualizar relê o arquivo; não raspa. Cotações ~15 minutos atrasadas em relação ao horário da raspagem.
