...
- **Indicadores (IFR, MM200, Bollinger, HV)** → `src/venda_de_put/indicators.py` e `docs/sdd.md`. Ideia futura (último período = instante da raspagem): `docs/superpowers/specs/2026-08-17-indicadores-ultimo-periodo.md`.
